...
This repo is indexed by StrataGraph as **this repo** (3059 nodes, 24114 edges; planes present: code/contract/infra). The MCP tools below let you understand the code, assess blast radius across planes, and navigate safely.
